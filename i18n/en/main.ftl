...
admin-home-group-access-desc = Manage who authenticates to this IdP: people (users and members) and machines (service accounts).
admin-home-group-integration = Relying parties and keys
admin-home-group-integration-desc = Manage the apps that receive identities from this IdP, and the signing keys.
...
admin-nav-clients-desc = Register apps that sign users in with this IdP
...
admin-nav-saml-clients-desc = Register SAML service providers that trust this IdP.
...
admin-external-idps-choose-oidc-desc = Accepts an ID token as a sign-in. You enter the authorization and token endpoints, the JWKS URI, and the client ID the provider issued to this IdP.
