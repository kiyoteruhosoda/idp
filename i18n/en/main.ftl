...
admin-external-idps-intro = Let people sign in with an external OpenID Provider. The client secret is stored encrypted and is never shown again.
...
admin-external-idps-col-redirect = Redirect URI to register
