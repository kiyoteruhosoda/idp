...
use crate::presentation::dto::{
    AcceptInvitationRequest, AddTenantDomainRequest, ApplicationAssignmentResponse,
    ...
    MemberApplicationListResponse, MemberApplicationResponse, MemberListResponse,
    MemberNoteResponse, MemberResponse, OAuthErrorResponse, RegisterRequest,
    RegisterResourceRequest, RegisterResponse, ResourceListResponse, ResourceResponse,
    RestartServiceResponse, RuntimeSettingResponse, SettingChoiceResponse, SigningKeyResponse,
    SmtpSettingsResponse, SystemSettingsResponse, TenantAdminPasswordResetRequest,
    TenantDomainResponse, TenantListResponse, TenantOverrideResponse, TenantResponse,
    TenantSettingResponse, TenantSettingsListResponse, TenantSmtpSettingsResponse, TokenRequest,
    TokenResponse, UpdateApplicationRequest, UpdateMemberNoteRequest, UpdateMemberStatusRequest,
    UpdateResourceStatusRequest, UpdateRuntimeSettingRequest, UpdateSmtpSettingsRequest,
    UpdateSystemSettingsRequest, UpdateTenantRequest, UpdateTenantSettingRequest,
...
#[openapi(
    ...
    paths(
        ...
        handlers::admin_applications::list_applications,
        handlers::admin_applications::get_application,
        handlers::admin_applications::create_application,
        handlers::admin_applications::update_application,
        handlers::admin_applications::delete_application,
        handlers::admin_applications::add_binding,
        handlers::admin_applications::remove_binding,
        handlers::admin_applications::assign_user,
        handlers::admin_applications::unassign_user,
        handlers::admin_applications::unassign_service_account,
        ...
        handlers::admin_tenant_settings::list_tenant_settings,
        handlers::admin_tenant_settings::set_tenant_setting,
        handlers::admin_tenant_settings::clear_tenant_setting,
        handlers::admin_system_settings::get_system_settings,
        handlers::admin_system_settings::update_system_settings,
        handlers::admin_system_settings::get_smtp_settings,
        handlers::admin_system_settings::update_smtp_settings,
        handlers::admin_tenant_smtp::get_tenant_smtp,
        handlers::admin_tenant_smtp::update_tenant_smtp,
        handlers::admin_tenant_smtp::clear_tenant_smtp,
        ...
        handlers::admin_members::update_member_note,
        handlers::admin_applications::list_member_applications,
    ...
    components(schemas(
        ...
        CreateApplicationBindingRequest,
        CreateApplicationAssignmentRequest,
        ApplicationResponse,
        ApplicationBindingResponse,
        ApplicationListResponse,
        ApplicationDetailResponse,
        ApplicationAssignmentResponse,
        ApplicationServiceAccountAssignmentResponse,
        ApplicationCurrentUsersResponse,
        ApplicationCurrentUserResponse,
