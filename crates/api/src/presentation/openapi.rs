...
#[openapi(
    ...
    paths(
        ...
        handlers::admin_resources::delete_resource,
        handlers::admin_resources::list_client_resources,
        handlers::admin_resources::grant_client_resource,
        handlers::admin_resources::revoke_client_resource,
